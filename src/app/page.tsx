...
import { Card, Input, message, Modal, Typography } from "antd";
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-black">
      ...
      <div
        className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-radial from-cyan-500/5 to-transparent rounded-full animate-spin"
          ...
          >
            ...
            >
              <Text className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
                Experience the future of compliance management with quantum-powered intelligence. Revolutionary
                technology meets regulatory excellence.
              </Text>
            </motion.div>
      ...
      >
        <div style={{ marginTop: "16px" }}>
          ...
          >
            Be the first to experience quantum-powered compliance management. We'll notify you as soon as Q-Consent
            launches!
          </p>
